package com.lfp.timeline.demo.widget;
...
import com.lfp.timeline.TimeLineView;
import com.lfp.timeline.TimeValueEvent;
import com.lfp.timeline.demo.widget.style.CoolWaitLoadingRenderer;
...
public class WaitProgressBar extends TimeLineView {
    ...
    void init() {
        mCoolWaitLoadingRenderer = new CoolWaitLoadingRenderer(getContext());
