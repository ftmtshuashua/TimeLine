package com.lfp.timeline.demo.widget.style;
...
public class CoolWaitLoadingRenderer {
    ...
    private final float DEFAULT_STROKE_WIDTH = 4.0f;
    private final float WAIT_CIRCLE_RADIUS = 20.0f;
    ...
    private void init(Context context) {
        mStrokeWidth = dip2px(DEFAULT_STROKE_WIDTH, context);
        mWaitCircleRadius = dip2px(WAIT_CIRCLE_RADIUS, context);
    ...
    public void setCircleRadius(float value) {
        mWaitCircleRadius = value;
        setStrokeWidth(mWaitCircleRadius * 8 / 50);
    }
